...
with tab1:
    ...
    with col1:
        ...
        S1 = st.number_input('患者年龄', min_value=0, max_value=200, value=45, step=1,
                             help="患者年龄，范围：0-200岁")
        S2 = st.number_input('A孔斑点数', min_value=0, max_value=2000, value=100, step=1,
                             help="A孔斑点数，范围：0-2000")
        S3 = st.number_input('B孔斑点数', min_value=0, max_value=2000, value=80, step=1,
                             help="B孔斑点数，范围：0-2000")
        S4 = st.number_input('阳性孔斑点数', min_value=0, max_value=2000, value=20, step=1,
                             help="阳性孔斑点数，范围：0-2000")
        st.markdown('</div>', unsafe_allow_html=True)

    with col2:
        st.markdown('<div class="input-section">', unsafe_allow_html=True)
        S5 = st.number_input('A孔斑点平均体积', min_value=0.00, max_value=100.00, value=1.00, step=0.01,
...
with tab2:
    ...
    if uploaded_file is not None:
        try:
            ...
            # 检查必要的列
            required_columns = ['患者年龄', 'A孔斑点数', 'B孔斑点数', '阳性孔斑点数',
                                'A孔斑点平均体积', 'B孔斑点平均体积', 'TBAg/PHA']
...
<div style="text-align: center; color: gray; font-size: 0.9rem;">
    <p>医疗预测分析系统（测试用）by Zoldyck | 版本 1.0 | 最后更新: 2026/02/04</p>
</div>
""", unsafe_allow_html=True)